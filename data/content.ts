      ...
      items: [
        {
          ...
          highlights: [
            ...
            "Hiểu sâu về hệ thống reactivity và Composition API của Vue 3, bao gồm ref, reactive, computed, watch, watchEffect và các lifecycle hook của component như onBeforeUnmount và onUnmounted.",
            "Hiểu rõ về Pinia trong quản lý state, bao gồm kiến trúc store, reactive state, getters, actions, cơ chế lưu trữ state và quản lý state dùng chung giữa các component.",
